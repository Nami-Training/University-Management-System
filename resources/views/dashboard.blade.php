                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.students_number') }}</p>
                                    <h4>{{$studentsCount}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('Students.index')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.show') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.teachers_number') }}</p>
                                    <h4>{{$teachersCount}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('Teachers.index')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.show') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.classrooms_number') }}</p>
                                    <h4>{{$classroomsCount}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('Classrooms.index')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.show') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                <tr  class="table-info text-danger">
                                                    ...
                                                    <th>{{ trans('Students_trans.specialization') }}</th>
                                                    <th>{{ trans('Students_trans.join_date') }}</th>
                                                </tr>
                                                </thead>
                                    ...
                                    <div class="tab-pane fade" id="fee_invoices" role="tabpanel" aria-labelledby="fee_invoices-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                @empty
                                                    <tr>
                                                        <td class="alert-danger" colspan="9">{{ trans('main_trans.there_no_data') }}</td>
                                                    </tr>
                                                @endforelse
                                                </tbody>
                                            </table>
