                                                                                        ...
                                                                                        <form
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col">
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control"
                                                                                                        value="{{ $list_Sections->translate( 'ar')->Name }}">
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="col">
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        class="form-control"
                                                                                                        value="{{ $list_Sections->translate( 'en')->Name }}">
                                                                                                    <input id="id"
                                                                                                        type="hidden"
                                                                                                        name="id"
                                                                                                        class="form-control"
                                                                                            ...
                                                                                            <div class="col">
                                                                                                ...
                                                                                                <select name="grade_id"
                                                                                                    ...
                                                                                                    @foreach ($Grades as $list_Grade)
                                                                                                        <option
                                                                                                            value="{{ $list_Grade->id }}" @selected( $Grade->Name == $list_Grade->Name)>
                                                                                                            {{ $list_Grade->Name }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                            ...
                                                                                            <div class="col">
                                                                                                ...
                                                                                                <select name="Status" class="custom-select">
                                                                                                    <!--placeholder-->
                                                                                                    <option value="1" @selected($list_Sections->Status == 1)>{{ trans('Sections_trans.Status_Section_AC') }}
                                                                                                    </option>
                                                                                                    <option value="0" @selected($list_Sections->Status == 0)>{{ trans('Sections_trans.Status_Section_No') }}
                                                                                                    </option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <br>
                                                                        ...
                                                                        <div class="modal fade"
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form
                                                                                            action="{{ route('Sections.delete',$list_Sections->id) }}"
                                                                                            method="post">
                                                                                            @method('delete')
                                                                                            @csrf
                                    ...
                                    <form action="{{ route('Sections.store') }}" method="POST">
                                            ...
                                            @foreach (config('app.languages') as $key => $lang)
                                                <div class="col">
                                                    <input type="text"name="{{ $key }}[Name]" class="form-control"
                                                           placeholder="{{ trans('Sections_trans.Section_name_' . $key) }}">
                                                </div>
                                            @endforeach
                                        </div>
                                        <br>
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="classroom_id" class="custom-select">
                                                <!--placeholder-->
                                                <option value="" selected
                                                        disabled>{{ trans('Sections_trans.Select_Class') }}
                                                </option>
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="Status" class="custom-select">
                                                <!--placeholder-->
                                                <option value="1">{{ trans('Sections_trans.Status_Section_AC') }}
                                                </option>
                                                <option value="0">{{ trans('Sections_trans.Status_Section_No') }}
                                                </option>
                                            </select>
                                        </div>
