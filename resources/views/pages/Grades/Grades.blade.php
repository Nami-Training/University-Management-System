                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('Grades.update', $Grade->id) }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <label for="Name_{{ $key }}"
                                                                class="mr-sm-2">{{ trans('Grades_trans.stage_name_'.$key) }}
                                                                :</label>
                                                            <input id="Name_{{ $key }}" type="text" name="{{ $key }}[Name]"
                                                                class="form-control"
                                                                value="{{ $Grade->translate($key)->Name }}"
                                                                required>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('Grades.store') }}" method="POST">
                        ...
                        <div class="row">
                            @foreach (config('app.languages') as $key => $lang)
                                <div class="col">
                                    <label for="Name_{{ $key }}" class="mr-sm-2">{{ trans('Grades_trans.stage_name_'. $key) }}
                                        :</label>
                                    <input id="Name_{{ $key }}" type="text" name="{{ $key }}[Name]" class="form-control">
                                </div>
                            @endforeach
                        </div>
                        <div class="form-group">
