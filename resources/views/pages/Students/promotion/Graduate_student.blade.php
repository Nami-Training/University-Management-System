    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('graduated.graduateStudentFromPromotion',$promotion->id)}}" method="post">
                    @csrf
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('Students_trans.garduate_Warning') }} : {{$promotion->student->Name}}</h5>
