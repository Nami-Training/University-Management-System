                        ...
                        <div class="row">
                            @foreach (config('app.languages') as $key => $lang)
                                <div class="col">
                                    ...
                                    <input type="text"  name="{{ $key }}[Name]" class="form-control" id="Name_{{ $key }}" value="{{$student->translate($key)->Name}}">
                                </div>
                            @endforeach
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="gender_id">
                                        ...
                                        @foreach($Genders as $Gender)
                                            <option value="{{$Gender->id}}" @selected($Gender->id == $student->gender_id)>{{ $Gender->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        @foreach($nationals as $nal)
                                            <option value="{{ $nal->id }}" @selected($nal->id == $student->nationalitie_id)>{{ $nal->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($bloods as $bg)
                                            <option value="{{ $bg->id }}" @selected($bg->id == $student->blood_id)>{{ $bg->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
