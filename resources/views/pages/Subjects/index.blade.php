                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('subject.processing') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($subjects as $subject)
                                            ...
                                            <td>{{$subject->teacher->Name}}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_subject{{ $subject->id }}" title="{{ trans('Grades_trans.Delete') }}"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                                    ...
                                                    <form action="{{route('Subjects.delete',$subject->id)}}" method="post">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p> {{ trans('subject.Warning_subject') }} {{$subject->name}}</p>
