...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Students_trans.Fee_invoices') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    {{-- <a href="{{route('Fees_Invoices.show',$Fee_invoice->id)}}" class="btn btn-success btn-sm" role="button"
                    aria-pressed="true">Add Fees_Invoices</a><br><br> --}}
