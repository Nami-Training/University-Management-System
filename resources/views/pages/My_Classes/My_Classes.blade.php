                                            ...
                                            <form action="{{ route('Classrooms.update',  $My_Class->id) }}" method="post">
                                                ...
                                                <div class="row">
                                                    @foreach (config('app.languages') as $key => $lang)
                                                        <div class="col">
                                                            <label for="Name_{{ $key }}"
                                                                class="mr-sm-2">{{ trans('My_Classes_trans.Name_class_' . $key) }}
                                                                :</label>
                                                            <input class="form-control" type="text" name="{{ $key }}[Name]" id="Name_{{ $key }}" value="{{ $My_Class->translate($key)->Name }}" required>
                                                        </div>
                                                    @endforeach
                            ...
                            <div class="modal fade" id="delete{{ $My_Class->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('Classrooms.delete', $My_Class->id) }}"
                                                  method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
